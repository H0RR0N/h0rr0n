...
class DoctorSchedule(models.Model):
    """Business model for DoctorSchedule records."""
    ...
    def _selection_label(self, field_name, value):
        """Return selection label for label."""
    ...
    def _check_schedule_day_definition(self):
        """Validate schedule day definition."""
    ...
    def _onchange_time_range(self):
        """Handle onchange for time range."""
        for rec in self:
